      ...
      >
        <div className="max-w-lg mx-auto p-6 shadow-lg bg-black rounded-2xl border border-gray-700 flex flex-col items-center">
          ...
          <div className="flex flex-col justify-center items-center mb-6">
            ...
            <button type="button" onClick={() => window.open("https://space.hello.app")} className="pointer-events-auto relative overflow-hidden rounded-lg bg-black px-24 py-6 ring-red-500/50 ring-offset-black will-change-transform focus:outline-none focus:ring-1 focus:ring-offset-2 cursor-emoji">
              <span className="absolute inset-px z-10 grid place-items-center rounded-lg bg-black bg-gradient-to-t from-neutral-800 text-neutral-400">
                <b>Join beta</b>
              </span>
              <span
