    ...
    <section className="relative h-screen">
      ...
      >
        <div className="max-w-lg mx-auto p-6 shadow-lg bg-black rounded-2xl border border-gray-700 flex flex-col items-center">
          ...
          <button type="button" onClick={() => setShowModal(true)} className="pointer-events-auto relative overflow-hidden rounded-lg bg-black px-24 py-6 ring-red-500/50 ring-offset-black will-change-transform focus:outline-none focus:ring-1 focus:ring-offset-2 cursor-emoji">
